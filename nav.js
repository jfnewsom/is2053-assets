...
(function () {
  ...
  /* Modality variants live in parallel trees with the same structure as
     /pages/, generated by render_variant.py. Detect which tree we are in so
     nav links keep a student inside their own modality. /pages/ is both the
     authoring source and the online site, so it is the fallback.
